  ...
  return (
    <div className='justify-center bg-gradient-to-r w-screen from-[#020443] to-[#02030C] h-[150vh]'>
      ...
      <div className='flex justify-around mt-2 cursor-pointer text-white'>
        ...
        <div onClick={handleStudentClick} className='items-center text-center cursor-pointer'>
      ...
      {registered ? (
        <p onClick={changeSession} className='w-48 m-auto cursor-pointer text-center text-gray-500 mt-8'>
          Create new account
        </p>
      ) : (
        <p onClick={changeSession} className='w-56 m-auto cursor-pointer text-center text-gray-500 mt-8'>

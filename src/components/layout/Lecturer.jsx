...
function Lecturer() {
  ...
  return (
    <div className='bg-gray-100 h-full pb-16'>
      ...
      {showAddForm && (
        <div className='fixed top-10 left-1/2 transform -translate-x-1/2 w-[90%] max-w-md bg-white py-4 px-6 border-b-2 border-gray-300 rounded-md shadow-lg' ref={formRef}>
